...
import {startSearch, likeThis, skipThis, dropAvatar, avatarLoaded, avatarError} from '../actions/GroupViewActions'
                ...
                if (offset < items.length) {
                    ...
                    return (<div className="GrpupView__center">
                        <div className={photoWrapperClass}>
                            <img className={avatarClass} onError={this.onErrorAvatar.bind(this)} onLoad={this.onLoadAvatar.bind(this)} src={user.photo_max_orig}/>
                        </div>
...
export default connect(mapStateToProps, {startSearch, likeThis, skipThis, dropAvatar, avatarError, avatarLoaded})(GroupView)
